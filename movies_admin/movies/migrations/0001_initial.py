    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('movie', 'movie'), ('tw_show', 'tw_show')], max_length=16, verbose_name='type')),
            ],
            options={
                'verbose_name': 'film_prodaction',
                'verbose_name_plural': 'film_prodactions',
